  ...
  return (
    <AppTerminal>
      ...
      <span className="text-sm  text-zinc-100 mt-4">
        String <span className=" text-purple-400">nome</span> ={" "}
      ...
      <span className="text-sm text-zinc-100">
        String <span className="text-purple-400">formacao</span> ={" "}
        <span className="text-green-400">"ADS | Cursando"</span>;
      </span>

      <span className="text-sm text-zinc-100">
        String <span className="text-purple-400">atuacao</span> =
        <span className="text-green-400"> "Backend | Fullstack"</span>;
      </span>

      <span className="text-sm text-zinc-100">
        String <span className="text-purple-400">localizacao</span> ={" "}
